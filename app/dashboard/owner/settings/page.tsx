...
export default function OwnerSettingsPage() {
  const [activeTab, setActiveTab] = useState('store'); // store, security, license
  ...
  <div className="max-w-6xl mx-auto space-y-10 pb-20">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
      ...
      <div className="lg:col-span-4 space-y-10">
        ...
        {/* Upgrade Banner */}
        <div className="bg-indigo-600 rounded-[3.5rem] p-10 text-white relative overflow-hidden group cursor-pointer shadow-2xl shadow-indigo-200">
          ...
          <div className="relative z-10 space-y-6">
            ...
            <div className="space-y-2">
              <h4 className="text-2xl font-black italic tracking-tighter">CASHIERIN PRO</h4>
              <p className="text-indigo-100/70 text-xs font-medium leading-relaxed italic">Aktifkan lisensi penuh sekarang untuk fitur Cloud Hub, Multi-Store, dan Manajemen Lanjutan.</p>
            </div>
            <button
              onClick={() => setActiveTab('license')}
              className="w-full h-14 bg-white text-indigo-600 font-black uppercase tracking-[0.25em] text-[10px] rounded-2xl flex items-center justify-center gap-3 hover:bg-slate-100 transition-all shadow-xl"
            >
              Go Unlimited <ChevronRight size={16} />
            </button>
          </div>
        </div>
